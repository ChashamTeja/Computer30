...
public class Account {
	...
	public Account(double bal, String fName, String lName)//include street, city, province or state, postal code or zip code
	 {
		balance = bal;
		cust = new Customer(lName, lName, lName, lName, lName, lName);//this constructor should reflect the new additions above, street, city, province, postal code
